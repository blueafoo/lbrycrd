...
public:
    ...
    //! Wait for pending notifications to be processed and the tip block hash to match
    virtual void waitForNotificationsAndTip(std::function<uint256(void)> getCurrent) = 0;
